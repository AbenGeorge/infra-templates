...
resource "google_app_engine_flexible_app_version" "appengine_flexible_automatic_scaling" {
  ...
  service_account = var.ae_service_account
...
resource "google_app_engine_application_url_dispatch_rules" "dispatch_rules" {
  ...
  dispatch_rules {
    domain  = var.domain
    path    = var.path
    service = google_app_engine_flexible_app_version.appengine_flexible_automatic_scaling.service
  }
  depends_on = [ 
    google_app_engine_flexible_app_version.appengine_flexible_automatic_scaling
  ]
}